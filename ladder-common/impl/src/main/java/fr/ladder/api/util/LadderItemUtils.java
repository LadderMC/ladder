...
import fr.ladder.api.bukkit.item.*;
import fr.ladder.polyglot.*;
...
public class LadderItemUtils implements ItemUtils.Implementation {
    ...
    public ItemBuilder getBackItem() {
        return this.createSkull()
                .setTexture(SkinUtils.get("item/back"))
                .setName(Messages.get("common.items.back"));
    }

    @Override
    public ItemBuilder getPreviousItem() {
        return this.createSkull()
                .setTexture(SkinUtils.get("item/previous"))
                .setName(Messages.get("common.items.previous"));
    }

    @Override
    public ItemBuilder getNextItem() {
        return this.createSkull()
                .setTexture(SkinUtils.get("item/next"))
                .setName(Messages.get("common.items.next"));
    }
    ...
    public BannerBuilder getBannerMinus(DyeColor color, String value) {
        ...
        return banner.setName(banner.toChatColor() +
                Messages.get("common.items.banner.minus", Var.of("s", value)));
    }
    ...
    public BannerBuilder getBannerPlus(DyeColor color, String value) {
        ...
        return banner.setName(banner.toChatColor() +
                Messages.get("common.items.banner.plus", Var.of("s", value)));
    }
    ...
    public int getBonusWithFortune(ItemStack itemInHand) {
        ...
        return _random.nextInt(1 + level);
    }
}